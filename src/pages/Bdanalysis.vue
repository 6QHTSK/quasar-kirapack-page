<template>
  <div>
    <q-card>
        <q-card-section style="text-align: center;margin-top: 10px;margin-bottom: 10px;">
    ...
    <q-card>
      <q-tabs v-model="tab" dense class="text-grey" active-color="primary" indicator-color="primary" align="justify" narrow-indicator>
        ...
        <q-tab label="发谱最多的谱师" name="5"/>
        <q-tab label="获赞最多的谱师" name="6"/>
        <q-tab label="EX/SP难度最高的谱师" name="7"/>
        <q-tab label="EX/SP难度最低的谱师" name="8"/>
        <q-tab label="最热门的单曲" name="9"/>
        <q-tab label="最热门的艺术家" name="10"/>
      </q-tabs>
      <q-separator />
        <q-tab-panels v-model="tab" animated>
            <q-tab-panel name="0">
                <div class="column q-gutter-sm justify-evenly">
                    <q-select filled v-model="searchuser" use-input hide-selected fill-input clearable input-debounce="200" :options="options" @filter="filterFn"
                        ...
                        <q-markup-table>
                            ...
                            <tbody>
                                <tr v-for='row in searchres["npscount"]' v-bind:key="row[0]">
                                    ...
                                    <td class="text-center">{{row[3]}}</td>
                                    <td class="text-center">{{row[4]}}</td>
                                    <td class="text-center">{{row[5].toFixed(2)}}</td>
                                </tr>
                            </tbody>
                        </q-markup-table>
                    </q-tab-panel>
